...
<Tabs>
  ...
  <Tab title="Auto">
    The `"auto"` mode inspects the environment and picks the best available backend. If Vercel Sandbox credentials are present, it uses Vercel; otherwise it falls back to Docker.
