...
description: "Understand how niceeval's core, agent adapters, and sandbox backends fit together to evaluate any AI agent with a unified TypeScript API."
---
...
```
   ...
   button.eval.ts  --upload-->        │                        └─ sandbox adapter ─── Sandbox
     workspaces/button/               │                           (claude-code          (docker /
                                      ▼                            codex / bub …)        third-party)
