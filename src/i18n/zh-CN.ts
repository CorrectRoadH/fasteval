export const zhCN = {
  ...
  "report.summary.scored": "{{count}} 计分",
  ...
  "runner.noRemoteWorkspace": "remote agent 没有沙箱 workspace,不能运行 t.scriptPassed()/t.testsPassed();请改用 sandbox agent。",
  ...
  "runner.sandboxSetup": "sandbox setup(钩子)…",
